...
public class LoginFragment extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mState.accountRequest.getTokenLiveData().observe(getViewLifecycleOwner(), dataResult -> {
            if (!dataResult.getResponseStatus().getSuccess()) {
                mState.loadingVisible.set(false);
                ToastUtils.showLong(getString(R.string.network_state_retry));
                return;
            }
    ...
    public class ClickProxy {
        ...
        public void login() {
            ...
            if (TextUtils.isEmpty(mState.name.get()) || TextUtils.isEmpty(mState.password.get())) {
                ToastUtils.showShort(getString(R.string.username_or_pwd_incomplete));
                return;
            }
