...
import com.wsm.base_scaffold.building.ui.page.BaseActivity;
...
public class MainActivity extends BaseActivity {
    ...
    protected DataBindingConfig getDataBindingConfig() {
        ...
        return new DataBindingConfig(R.layout.activity_main, BR.vm, mState).addBindingParam(BR.event, new EventHandler());
    }
