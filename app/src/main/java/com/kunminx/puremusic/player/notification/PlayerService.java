...
public class PlayerService extends Service {
    ...
    private void requestAlbumCover(String coverUrl, String musicId) {
        ...
        UseCaseHandler.Companion.getInstance().execute(mDownloadUseCase,
                new DownloadUseCase.RequestValues(coverUrl, musicId + ".jpg"), new IUseCaseCallback<DownloadUseCase.ResponseValue>() {
                    @Override
                    public void onError() {
