...
import com.wsm.base_scaffold.data.response.DataResult;
import com.wsm.base_scaffold.domain.request.BaseRequest;
import com.wsm.base_scaffold.domain.usecase.IUseCaseCallback;
import com.wsm.base_scaffold.domain.usecase.UseCaseHandler;
...
public class DownloadRequest extends BaseRequest {
    ...
    public void requestCanBeStoppedDownloadFile() {
        UseCaseHandler.Companion.getInstance().execute(getCanBeStoppedUseCase(), new CanBeStoppedUseCase.RequestValues(), new IUseCaseCallback<CanBeStoppedUseCase.ResponseValue>() {
            @Override
            public void onError() {
            ...
            @Override
            public void onSuccess(@Nullable CanBeStoppedUseCase.ResponseValue response) {
